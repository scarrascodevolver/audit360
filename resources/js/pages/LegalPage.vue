<template>
    <div class="min-h-screen bg-bg-light py-10">
        <div class="mx-auto max-w-3xl space-y-6 px-4 sm:px-6">
            <section class="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-gray-100 sm:p-10">
                <h1 class="font-heading text-2xl font-black text-navy sm:text-3xl">{{ titulo }}</h1>
                ...
                <router-link to="/" class="mt-8 inline-flex items-center gap-2 text-sm font-bold text-teal transition hover:text-teal-dark">
                    ← Volver al inicio
                </router-link>
            </section>
        </div>
